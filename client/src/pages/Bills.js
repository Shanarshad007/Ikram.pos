        ...
        >
          <div className="bill-model p-3" ref={componentRef}>
            <div className="d-flex justify-content-between bill-header pb-2">
              ...
              <div> 
                <p>25NUMBER STOP INFRONT OF ASKARI BANK SHAHDRA</p>
                <p>LAHORE</p>
                <p>MOBILE : 03238806097</p>
            ...
            <Table columns={cartcolumns} dataSource={selectedBill.cartitems} bordered rowKey={(record) => record._id} pagination={false} />
